...
async function serialize(msg, conn) {
  ...
  if (msg.message) {
    ...
    msg.adReply = async (text) => {
     var quot = [{"key": {"remoteJid": "status@broadcast","fromMe": false,"participant": "0@s.whatsapp.net"},"message": {"contactMessage": {"displayName": '𝐍𝐄𝐙𝐔𝐊𝐎 𝐌𝐃 ㋚',"vcard": "BEGIN:VCARD\nVERSION:3.0\nN:"+'ezraaaa'+"\nFN:"+'ezraaaa'+"\nitem1.TEL;waid=917607387121:917907387121\nitem1.X-ABLabel:Click To Chat\nitem2.EMAIL;type=INTERNET:GitHub: QUEEN-NEZUKO-BOT\nitem2.X-ABLabel:Follow Me On Github\nitem3.URL:YouTube: illa\nitem3.X-ABLabel:Youtube\nitem4.ADR:;;India, Kerala;;;;\nitem4.X-ABLabel:Region\nEND:VCARD"}}}]
     ...
     thumbnailUrl: "https://i.imgur.com/imOAWEN.jpeg" }},},{ quoted: zeta });
  }
